...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM anuncios_tb WHERE id =  $anuncio_id";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($anuncio = mysqli_fetch_assoc($result)) {
            ...
            $posto_por = $anuncio['posto_por'];
            $link_imagem = $anuncio['imagem_link'];
        }
    } else {
...
<body class="bg-secondary-subtle">
    ...
    <span class="d-flex justify-content-center">
        <p class="text-center fw-bold fs-2 bg-primary p-2 mt-2 rounded w-50 text-white">Editor de Anúncios</p>
    </span>

    <div class="d-flex justify-content-start">
        <a id="toggleButton" href="news.php" class="ms-5 d-flex btn btn-primary icon-link icon-link-hover"
    ...
    <div class="d-flex flex-wrap justify-content-center mt-5">
        ...
        <form class="row g-3" method="POST" action="processa_anuncio.php">
            ...
            <!--Link da Imagem-->
            <div class="col-md-6">
                <label for="imagem" class="form-label">Link da Imagem do Anuncio</label>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="imagem" name="imagem_link"
                        placeholder="URL da imagem do anuncio" aria-label="URL da imagem do anúncio"
            ...
            <div class="col-12">
                <button type="submit" name="editar" class="btn btn-primary w-100"><svg xmlns="http://www.w3.org/2000/svg" width="16"
