    ...
    <nav class="navbar navbar-expand-lg bg-secondary">
      <div class="container-fluid ">
        <a class="navbar-brand d-flex align-items-center text-white" href="home.php">
          <img src="../img/movie.png" alt="Logo" width="64" height="64" class="d-inline-block align-text-top bg-dark"
            id="logo">
          IFilmes
        </a>
        <div class=" d-flex justify-content-center collapse navbar-collapse " id="navbarNavDropdown">
          <ul class="navbar-nav ">
            <li class="nav-item opcao" style="border-bottom: 5px solid white;">
              <a class="nav-link active text-white text-center" aria-current="page" href="home.php">Home</a>
            </li>
      ...
      <a class="navbar-brand d-flex align-items-center me-2 ms-2 text-white btn btn-danger sair" href="sair.php"><svg
  ...
  <div class="d-flex flex-wrap justify-content-evenly mt-5">
    ...
    if ($result->num_rows > 0) {
      while ($info_filme = mysqli_fetch_assoc($result)) {
        if ($info_filme['SorN'] == '1') {
          echo '<div class="card border border-2 rounded bg-primary border-success m-1" style="width: 18rem;">';
        } else {
          echo '<div class="card border border-2 rounded bg-primary border-primary m-1" style="width: 18rem;">';
        }
        if ($logado == '19111413') {
